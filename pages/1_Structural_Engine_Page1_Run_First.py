...
if run_model:
    ...
    try:
        ...
        if ranking is None or ranking.empty:
            ...
            # BUYZONE FILTER REMOVED — v3 does not produce BuyZone_Heatmap
...
# ---------------------------------------------------------
st.markdown("### 📘 SPC Intraday Ranker v3 — Scientific Summary")

st.markdown("""
---
# Executive Summary — SPC Intraday Ranker v3

The SPC Intraday Ranker v3 is a **hybrid institutional‑grade scanning engine** that merges
