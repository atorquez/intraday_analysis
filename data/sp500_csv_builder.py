...
# Your existing hard-coded SP500 list
sp500 = [
...
print("Building SP500 CSV from live Yahoo Finance data...")
...
for ticker in sp500:
    try:
        ...
        rows.append({
            ...
            "Last Sale": info.get("currentPrice", None)
        })
...
df.to_csv("data/sp500_full_list.csv", index=False)

print("SP500 CSV generated → data/sp500_full_list.csv")
