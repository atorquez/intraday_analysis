...
def load_and_filter_all_sources(csv_paths, min_price=1, max_price=10):
    """
...
def generate_master_universe(min_price=1, max_price=10):
...
if __name__ == "__main__":
    generate_master_universe(min_price=1, max_price=10)
